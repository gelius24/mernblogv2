            ...
            {users && users.map(user => {
              return <Table.Body key={user._id} className="divide-y">
                <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  <Table.Cell>
                    <img src={user.profilePicture} className="w-10 h-10 rounded-full bg-gray-500" alt="user img" />
                  </Table.Cell>
          ...
          <Table hoverable>
            ...
            {posts && posts.map(post => {
              return <Table.Body key={post._id} className="divide-y">
                <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  <Table.Cell>
                    <img src={post.image} className="w-14 h-10 rounded-md bg-gray-500" alt="user img" />
                  </Table.Cell>
